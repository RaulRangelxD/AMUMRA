    ...
    <div className='flex flex-col w-full'>
      ...
      <article className='flex flex-col items-center px-2 lg:px-12 py-2 lg:py-8 justify-center'>
        <div className='grid grid-cols-1 lg:grid-cols-2 lg:flex-row w-full'>
          ...
          <motion.div
            className='grid grid-cols-2 justify-items-center gap-2 px-2 my-2 lg:my-0 w-full'
      ...
      <section className='flex flex-col lg:flex-row items-center px-2 lg:px-12 py-8 justify-center bg-gradient-to-r from-[#333399] to-[#ff00cc] text-default-light'>
        ...
        <motion.div className='w-full' viewport={{ amount: 0.8, once: true }} initial={{ opacity: 0, x: 80 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
      ...
      <motion.article
        className='flex flex-col items-center px-2 lg:px-12 py-2 lg:py-8 justify-center'
